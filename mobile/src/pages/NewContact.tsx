...
function NewContact({ navigation }: any) {
    ...
    function customAlert(message: string, alert: string) {
        return (
    ...
    function deletePhone(phone: IPhone) {
    ...
    function deleteEmail(email: IEmail) {
        ...
        try {
            ...
            if (name.length === 0) {
                ...
                try {
                    ...
                    await contactService.create(authorization!, { name, alias, phone: _phones, email: _emails });
